...
export const THEME = {
  light: {
    ...
    secondary: 'hsl(209 57% 97%)',
    secondaryForeground: 'hsl(213 22% 25%)',
    muted: 'hsl(209 57% 97%)',
  ...
  dark: {
    ...
    popover: 'hsl(213 28% 16%)',
    popoverForeground: 'hsl(213 20% 88%)',
    primary: 'hsl(198 52% 55%)',
    primaryForeground: 'hsl(0 0% 100%)',
    secondary: 'hsl(213 25% 20%)',
    secondaryForeground: 'hsl(213 20% 88%)',
    muted: 'hsl(213 25% 20%)',
